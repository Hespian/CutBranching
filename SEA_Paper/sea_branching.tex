...
rules when branching. In order to prune the search space, bounds on the largest
...
minimizes the number of edges among $N(v)$ performs best.
...
sections will demonstrate how we identify such vertices with little
computational overhead. Out of the candidates found we then select the vertex of
