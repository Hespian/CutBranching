...
default branching strategy on $79\%$\todo{insert final number} of all
($88\%$\todo{insert final number} of solved)
instances tested.
...
to \textcolor{red}{X}\todo{remove}. For the technique based on
...
backend. The KaFFPa partitioner is configured to use the \emph{strong} preset and the seed is set to 42 \todo{double check}. For branching we use
...
be found in Table~\ref{table:instance}.\todo{directed -> undirected}
...
\begin{table}
	...
	\begin{center}
		\begin{tabular}{|l|r|rr|rr|rr|}\hline
			Graph & max. deg. & \multicolumn{2}{c|}{Artik.} & \multicolumn{2}{c|}{st-cuts} & \multicolumn{2}{c|}{ND} \\
			\hline
			Sparse nets. & t (s) & t (s) & s & t (s) & s & t (s) & s \\
			\hline
...
\begin{table}
	...
	\begin{center}
		\begin{tabular}{|l|r|rr|rr|rr|rr|}\hline
			Graph & max. deg. & \multicolumn{2}{c|}{Twin} & \multicolumn{2}{c|}{Funnel} & \multicolumn{2}{c|}{Unconfined} & \multicolumn{2}{c|}{Combined}  \\
			\hline
			Sparse nets. & t (s) & t (s) & s & t (s) & s & t (s) & s & t (s) & s \\
			\hline
