...
one which was not solved by any algorithm). Branching on almost
twins is faster than max. degree branching on all DIMACS Clique instances that
were solved by any of the techniques. We also show results for a strategy that targets all reduction rules
