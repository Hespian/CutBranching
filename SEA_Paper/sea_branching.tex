...
and figures\todo{change if we don't use figures that don't show all results}
...
the Stanford Network Analysis Project (SNAP)~\cite{snapnets}\todo{@Christian:
  ...
  die Instanzen noch andere Sachen zitieren?}. Detailed instance information can
...
default strategy but can be solved in $48$\todo{Update after full results are in} (articualtion points) to $176$\todo{Update after full results are in} (nested
...
searching for branching vertices.\todo{write
...
\label{tab:summary_decomp}
  ...
  \begin{tabular}{|l|rr|rr|rr|rr|}
    ...
    Instance type $\rightarrow$ & \multicolumn{2}{c|}{PACE} & \multicolumn{2}{c|}{DIMACS} & \multicolumn{2}{c|}{SNAP} & \multicolumn{2}{c|}{All Instances}                                                                                    \\
       technique $\downarrow$   & all                       & solved                      & all                       & solved                & all                   & solved                & all                   & solved                \\
    \hline
...
\label{tab:summary_reduction}
  ...
  \begin{tabular}{|l|rr|rr|rr|rr|}
    \hline
    Instance type $\rightarrow$ & \multicolumn{2}{c|}{PACE} & \multicolumn{2}{c|}{DIMACS} & \multicolumn{2}{c|}{SNAP} & \multicolumn{2}{c|}{All Instances}                                                                                    \\
       reduction rule $\downarrow$   & all                       & solved                      & all                       & solved                & all                   & solved                & all                   & solved                \\
    \hline
