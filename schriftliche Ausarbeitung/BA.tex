...
\begin{algorithm}
	...
	\Begin{
		$S \leftarrow \{v\}$\;
		\While{$S\text{ has child }u\text{ with } |N(u)\cap S|\leq 1$}{
			$u \leftarrow \text{child of } S $\;
			\eIf{$|N(u)\cap S| == 0$}{\Return true\tcp*{Contradiction to Theorem \ref{unconfined}}}{$S\leftarrow S\cup\{u\}$}
		}
